...
- World map: pausable real-time sim. Settlements, resources, economy. NPCs on the map visualize goods flow. **No enemy armies, no war layer.** Sandbox feel, not campaign war.
