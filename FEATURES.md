...
6. Turn-based tactical combat with hardcoded fixed party (engine models basic actions + 4 equipped ability slots, data-driven ability definitions — ADR-0002; 0 HP = knockout with bleed-out-to-death rule — ADR-0003)
